  ...
  render() {
    return (
      <div className="App">
        ...
        <div
          className="container"
          style={{ marginLeft: "13em", marginRight: "0" }}
        >
          <Navbar />
          <Navbar2 />
          <div className="content-container">
            <Routes > 
              <Route path="/animal-clinic" element={<Landing />} />
              ...
              <Route
                ...
                element={<AdmissionPrintPreview />}
              />
              <Route
                path="/appoinmentListPreview"
                element={<AppoinmentListPreview />}
              />
              <Route
                path="/employeePreviewList"
                element={<EmployeeListPreview />}
              />
              <Route
                path="/prescriptionListPreview"
                element={<PrescriptionListPreview />}
              />
              <Route
                path="/shelterListPrintPreview"
                element={<ShelterListPrintPreview />}
              />
              <Route
                path="/supplierListPrintPreview"
                element={<SupplierListPrintPreview />}
              />
              <Route
                path="/userListPrintPreview"
                element={<UserListPrintPreview />}
              />
              <Route
                path="/orderListPrintPreview"
                element={<OrderListPrintPreview />}
              />
              <Route
                path="/employeeLoginListPreview"
                element={<EmployeeLoginPrintPreview />}
              />
              <Route
                path="/animalPrintPreview"
                element={<AnimalPrintPreview />}
              />
              <Route
                path="/itemListPrintPreview"
                element={<ItemListPrintPreview />}
              />
              <Route path="/inpatient" element={<InPatientList />} />
              <Route
                path="/vaccinePrintPreview"
                element={<VaccinePrintPreview />}
              />
